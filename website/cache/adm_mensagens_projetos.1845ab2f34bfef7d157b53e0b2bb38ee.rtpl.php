...
<div class="adm_content">
    ...
    <div>
        <p>Telefone</p>
        <p class="inputCliente"><?php echo htmlspecialchars( $mensagem["telefone"], ENT_COMPAT, 'UTF-8', FALSE ); ?></p>
    </div>
    <div>
        <p>Empresa</p>
        <p class="inputCliente"><?php echo htmlspecialchars( $mensagem["empresa"], ENT_COMPAT, 'UTF-8', FALSE ); ?></p>
    </div>
    <div>
        <p>Tipo de serviço</p>
        <p class="inputCliente"><?php echo htmlspecialchars( $mensagem["pretencao_projeto"], ENT_COMPAT, 'UTF-8', FALSE ); ?></p>
    </div>
    <div>
        <p>Enviado em</p>
    ...
    <?php if( $mensagem["file"] == 1 ){ ?>
    <div>
        <p>Enviado em</p>
        <button class="textButton">Download</button>
    </div>
    <?php } ?>
...
<script src="<?php echo ROUTE_WEBSITE; ?>/js/adm/MensagensProjeto.js"></script>