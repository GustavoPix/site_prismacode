                ...
                <div class="logoAndClose">
                    <div class="logo">
                        <a href="<?php echo ROUTE; ?>/">
                            <?php require $this->checkTemplate('headers/'.htmlspecialchars( $logo, ENT_COMPAT, 'UTF-8', FALSE ));?>
                        </a>
                    </div>
                    <div class="buttonMenu">
                        <?php require $this->checkTemplate("headers/close");?>
                    </div>
                </div>
                <div class="grid-1">
                    ...
                    <div class="grid-1" v-if="page == 1" key="project_two">
                        ...
                        <form action="">
                            ...
                            <label class="input" for="file_project">
                                <p>{{files | fil_files}}</p>
                                <?php require $this->checkTemplate("headers/check");?>
                            </label>
